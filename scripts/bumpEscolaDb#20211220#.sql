CREATE DATABASE  IF NOT EXISTS `EscolaDb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `EscolaDb`;
...
--
-- Table structure for table `tblBoletim`
--

DROP TABLE IF EXISTS `tblBoletim`;
...
--
-- Dumping data for table `tblBoletim`
--

LOCK TABLES `tblBoletim` WRITE;
/*!40000 ALTER TABLE `tblBoletim` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblBoletim` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-20 12:23:52
